            ...
            <div class="card recend-sales overflow-auto">
                <div class="card-body mt-4">
                    <form method="post" asp-action="Edit">                    
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Điểm giữa kỳ</label>
                            <div class="col-sm-8">
                                <input asp-for="Name" placeholder="nhập điểm" type="text" name="giuaky" class="form-control" placeholder="Nhập" required>
                            </div>
                        </div>
                        <div class="row mb-3">
